  ...
  <div class="app">
    ...
    <section class="description-panel" aria-labelledby="descriptionTitle">
      <div>
        ...
        <p>
          The script takes the user-specified center of each mounted sample and one known zone axis for each mount, then helps locate any desired reflection on any sample. This makes it practical to collect and rigorously document surface reconstructions during dynamic growth experiments.
        </p>
      </div>
